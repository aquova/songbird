...
export class GB {
    ...
    static __wrap(ptr) {
        const obj = Object.create(GB.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_gb_free(ptr);
    }
    /**
    */
    constructor() {
        var ret = wasm.gb_new();
        return GB.__wrap(ret);
    }
    /**
    */
    init_cpu() {
        wasm.gb_init_cpu(this.ptr);
    }
    /**
    * @param {DataView} data
    */
    load_rom(data) {
        wasm.gb_load_rom(this.ptr, addHeapObject(data));
    }
    /**
    */
    run() {
        wasm.gb_run(this.ptr);
    }
    /**
    * @returns {string}
    */
...
async function init(input) {
    ...
    imports.wbg.__wbg_byteLength_4f8141d4fab0d42d = function(arg0) {
        var ret = getObject(arg0).byteLength;
        return ret;
    };
    imports.wbg.__wbg_getUint8_f6055d2f51f213ef = function(arg0, arg1) {
